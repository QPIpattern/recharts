...
```{r}
#str(yuNetwork)
nodes <- read.csv(system.file('nodes.csv', package='recharts'), encoding='CP936')
links <- read.csv(system.file('links.csv', package='recharts'), encoding='CP936')
str(nodes)
str(links)
```
...
yu[, 1:3] <- sapply(1:3, function(col) tmcn::toUTF8(as.character(yu[,col])))
str(yu)
```
