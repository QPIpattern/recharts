...
1. Base Plots
    1. Cartesian Coordinate System
        ...
        1. [River Event Chart](Basic_Plots_05_eventRiver.html)
    1. Polar Coordinate System
        ...
        1. [Force Chart](Basic_Plots_14_Force.html)
        1. [Chord Chart](Basic_Plots_15_Chord.html)
        1. [Gauge Chart](Basic_Plots_16_Gauge.html)
    1. Other Plots
        - Mono-coordinate System
        1. [Word Cloud](Basic_Plots_21_Wordcloud.html)
        1. [Venn Chart](Basic_Plots_22_Venn.html)
        - Multi-coordinates System
        1. [Map](Basic_Plots_31_Map.html)
        1. [Tree Chart](Basic_Plots_32_Tree.html)
        1. [Treemap](Basic_Plots_33_Treemap.html)
        1. [Heatmap](Basic_Plots_34_Heatmap.html)
...
1. Axis/Widget Configuration
    ...
    - Graph Elements
    1. [`addMarkLine`](Widgets_11_markLine.html)
    1. [`addMarkPoint`](Widgets_12_markPoint.html)
    1. [`addGeoCoord`](Widgets_13_geoCoord.html)
    1. [`addNameMap`](Widgets_14_nameMap.html)
    - Widgets
...
1. Aesthetic Configuration
    ...
    1. [`relocWidget`](Widget_34_Relocation.html)
...
You can also yield an echarts object using `echartr` and then modify the object directly as you do to a S3 list, if you are familiar with echarts data structure.
