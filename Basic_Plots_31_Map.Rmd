...
g1 <- g %>% 
    addML(series='北京Top10', data=target[target$name1=='北京',], 
          smooth=TRUE, effect=line.effect, itemStyle=line.style) %>%
    addML(series='上海Top10', data=target[target$name1=='上海',], 
          smooth=TRUE, effect=line.effect, itemStyle=line.style) %>% 
    addML(series='广州Top10', data=target[target$name1=='广州',], 
          smooth=TRUE, effect=line.effect, itemStyle=line.style)
g1
...
g2 <- g1 %>%
    addMP(series=2, data=target2[target2$group=='北京', 2:3],
          effect=list(show=TRUE), symbolSize=jsSymbolSize, 
          itmeStyle=mp.style) %>%
    addMP(series=3, data=target2[target2$group=='上海', 2:3],
          effect=list(show=TRUE), symbolSize=jsSymbolSize, 
          itmeStyle=mp.style) %>%
    addMP(series=4, data=target2[target2$group=='广州', 2:3],
          effect=list(show=TRUE), symbolSize=jsSymbolSize, 
          itmeStyle=mp.style)
g2
