...
| type   | 'chord'. |
+--------+--------------------------------------------------------------------+
| subtype| - radar: c("ribbon","scale","scaletext","rotatelab","hidelab","clock","clockwise","asc","desc","ascsub","descsub") | 
...
Set `type` 'chord'. If the data structure does not include dual-direction relationship, no matter whether you assign `subtype` 'ribbon', ribbon will not display.
...
```{r}
echartr(deutsch, c(club, player), weight, role, z=year, type='chord', 
        sub='asc + descsub + rotatelab') %>% 
